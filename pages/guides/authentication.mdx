...
to the Polybase client. Signing a request populates the [`ctx.publicKey`](/guides/collections#context) variable inside your collection code, allowing you to write code that 
