...
The Polybase DB Mainnet is currently invite-only. If you have a production use case and would like to join the private mainnet, please [apply here](https://ask.polybase.xyz/mainnet).
