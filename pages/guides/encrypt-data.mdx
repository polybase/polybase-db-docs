...
Polybase DB can be publicly accessible (if [@public](permissions#public-on-collections) directive used). In the case of public data, sensitive data should be encrypted 
