...
- Use the Polybase DB API with a `?format=nft` flag for the [token URI](https://docs.openzeppelin.com/contracts/3.x/api/token/erc721#ERC721-_setTokenURI-uint256-string-) in your smart contract.
