...
const auth = new Auth({
  // Optional: origin of the domain you will deploy your app to, we will
  // try to calculate this automatically, but it may not always be present
  // DO NOT add any path after the protocol/domain
  origin: 'https://my.domain.xyz',
})
