...
There are also React hooks and providers for Polybase Client, designed to be use with [`@polybase/client`](https://www.npmjs.com/package/@polybase/client).
...
There are also React hooks and providers for [authentication](/authentication), designed to be use with [`@polybase/auth`](https://www.npmjs.com/package/@polybase/auth).
