...
<iframe width="560" height="315" src="https://www.youtube.com/embed/dZfpdNJYZPc" title="Build an NFT Gated Chat App using Polybase | Tutorial by Calum" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
